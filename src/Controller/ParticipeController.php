...
final class ParticipeController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_participe_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    public function edit(Request $request, Participe $participe, EntityManagerInterface $entityManager): Response
    {
        $form = $this->createForm(ParticipeType::class, $participe);
        $form->handleRequest($request);
    ...
    public function delete(Request $request, Participe $participe, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$participe->getId(), $request->getPayload()->getString('_token'))) {
